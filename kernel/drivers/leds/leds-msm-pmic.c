	...
	enum led_brightness value)
{
	...
	{
		printk("LYF_DEBUG msm_keypad_bl_led_set fastboot_power_off %d value %d\n",fastboot_power_off,value);
		if(value != LED_OFF)
			return;
	}	
	...
	{
		printk("LYF_DEBUG mipi_set_bl fastboot_power_off %d value %d\n",fastboot_power_off,value);
		printk("LYF_DEBUG mipi_set_bl fastboot_bklight_off %d value %d\n",fastboot_bklight_off,value);
