...
static struct dsi_cmd_desc hx8363a_display_off_cmds[] = {
	{DTYPE_DCS_WRITE, 1, 0, 0, 120, sizeof(hx8363a_display_off), hx8363a_display_off},
...
#else
	0xC1,0x01,
	0x06,0x0D,0x1E,0x2F,0x3F,0x51,0x60,0x71,
	0x80,0x8B,0x95,0x9F,0xA8,0xB1,0xBD,0xC8,
	0xCE,0xD5,0xDB,0xE1,0xE4,0xE7,0xEB,0xEE,
	0xF0,0xF2,0xF4,0xF7,0xF8,0xFA,0xFC,0xFD,
	0xFF,0xB1,0xDE,0xAE,0x90,0xDB,0x20,0xFC,
	0xA2,0x02,
...
static struct dsi_cmd_desc hx8363a_video_display_on_cmds[] = {
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 10, sizeof(hx8363a_video_power_setting), hx8363a_video_power_setting},
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 10, sizeof(hx8363a_video_mipi_setting), hx8363a_video_mipi_setting},	
...
static int mipi_hx8363a_lcd_on(struct platform_device *pdev)
{
	...
	static int if_lcd_backlight_opened=0;
	...
	if(!if_lcd_backlight_opened)
	{
		...
		{
			msleep(20);
			mipi_hx8363a_pdata->pmic_backlight(40);   
			if_lcd_backlight_opened = 1;
		}
	}
...
static int __init mipi_hx8363a_lcd_init(void)
{
  //if (boot_splash) {
    ...
    // pr_debug("%s called, but do nothing for boot splash=1\n", __func__);
  //} else {
