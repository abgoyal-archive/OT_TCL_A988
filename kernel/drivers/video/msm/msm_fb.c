...
static int msm_fb_resume_sub(struct msm_fb_data_type *mfd)
{
	...
	if (fastboot_power_off == 1) {
		printk("msm_fb_set_backlight break ++++++++++++++++++\n");
		return 0;
	}
...
#define MSMFB_SCREEN_ISON 0x22111122
	static unsigned int screen_on_state;
	int ret = 0;
	...
	case MSMFB_SCREEN_ISON:
		printk("msm_fb_ioctl MSMFB_SCREEN_ISON +++++\n");
		ret = screen_on_state;
		printk("msm_fb_ioctl MSMFB_SCREEN_ISON -----\n");
		break;		
